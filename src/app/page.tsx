...
export default function Home() {
  ...
  return (
    <div className="flex h-screen">
      <div className="w-1/3 bg-gray-800 text-white p-4 flex flex-col">
            ...
            .map((user) => (
              <div
                ...
                className={`p-3 cursor-pointer rounded mb-2 transition ${
                  selectedUser?.id === user.id ? "bg-gray-600" : "hover:bg-gray-700"
                }`}
              >
                {user.name}
              </div>
      ...
      <div className="w-2/3 bg-gray-100 flex flex-col">
        {selectedUser ? (
          <>
            ...
            <div className="flex-1 p-4 overflow-y-auto">Chat messages here...</div>
            <div className="p-4 border-t bg-white flex">
              ...
              />
              <button className="px-4 bg-blue-500 text-white rounded-r">Send</button>
            </div>
          </>
        ) : (
